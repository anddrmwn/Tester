...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
        ...
        $query = "UPDATE `tb_pajak` SET `tanggal`='$tanggal', `gaji`='$gaji',`nama_lengkap`='$nama_lengkap',`jenis_pajak`='$jenis_pajak',`npwp`='$npwp',`persentase`='$persentase',`jumlah`='$jumlah',`deskripsi`='$deskripsi',`tipe`='$tipe' WHERE `pajak_id`='$id'";
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="jenis_pajak" id="jenis_pajak" class="form-control form-control-sm" required>
                                                ...
                                                <option value="PPH" <?= $res['jenis_pajak'] === 'PPH' ? 'selected' : '' ?>>PPH</option>
                                                <option value="PPN" <?= $res['jenis_pajak'] === 'PPN' ? 'selected' : '' ?>>PPN</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
